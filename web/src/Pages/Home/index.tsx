                 ...
                 <h2>Funcionalidades Principais</h2>
                    <div className="shortcutArea">
                        <div className="shortcutItem">
                            ...
                            <Link to="/announcements" className="shortcutItemLink"> Enviar Bilhete </Link>
                        </div>
                        <div className="shortcutItem">
                            <Icon.Send color="#5686F9" size={42} />
                            <Link to="/scraps" className="shortcutItemLink"> Enviar Recado </Link>
                        </div>
                        <div className="shortcutItem">
                            <Icon.Bell color="#5686F9" size={42} />
                            <Link to="/requests" className="shortcutItemLink"> Solicitações </Link>
                        </div>
                        <div className="shortcutItem">
                            <Icon.Save color="#5686F9" size={42} />
                            <Link to="/studentRegister" className="shortcutItemLink"> Cadastrar Aluno </Link>
                        </div>
                        <div className="shortcutItem">
                            <Icon.List color="#5686F9" size={42} />
                            <Link to="/classesList" className="shortcutItemLink"> Listar Turmas </Link>
                        </div>
                    </div>
                </div>
                <div>
