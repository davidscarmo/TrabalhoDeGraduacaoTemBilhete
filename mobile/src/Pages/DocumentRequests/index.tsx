...
import { KeyboardAvoidingView, TextInput, View, Text, Alert, AsyncStorage } from 'react-native';
...
const DocumentRequests = () => 
{
    ...
    const handleDocumentRequest = async ()=> 
    {
        ...
        {
                Alert.alert('Não foi possível solicitar o documento.\nTente Novamente! '); 
        } ); 
    ...
    return(
        <View style={styles.container}>
            <PageHeader barTitle="Solicitações" headerTitle="Peça documentos de maneira fácil por aqui" />
            <KeyboardAvoidingView behavior="height" style={styles.formBlock}> 
            <View style={styles.formArea}>
                <Text style={styles.formAreaTitle}>
                    Dados
                </Text>
                ...
                items={
                [
                    {label: 'Atestado de Frequência', value: 'Atestado de Frequência'},
                    {label: 'Histórico Escolar', value: 'Histórico Escolar'},
                    {label: 'Transferência Escolar', value: 'Transferência Escolar'},
                ]}
                />
